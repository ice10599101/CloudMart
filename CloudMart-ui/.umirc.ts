  ...
  routes: [
    {
      ...
      routes: [
        ...
        { path: '/wish/starlight-log', component: '@/pages/StarlightLog' },
        ...
        { path: '/wish/signin', component: '@/pages/DailySignin' },
        { path: '/wish/collections', component: '@/pages/WishCollections' },
        { path: '/wish/workshop', component: '@/pages/WishWorkshop' },
        { path: '/wish/badges', component: '@/pages/BadgeWall' },
        { path: '/wish/tree', component: '@/pages/WorldTree3D' },
        { path: '/wish/capsules', component: '@/pages/CapsuleList' },
        { path: '/wish/capsules/create', component: '@/pages/CapsuleCreate' },
        { path: '/wish/capsules/:id', component: '@/pages/CapsuleDetail' },
        { path: '/wish/assistant', component: '@/pages/AiAssistant' },
        { path: '/wish/annual-report', component: '@/pages/AnnualReport' },
        { path: '/wish/match', component: '@/pages/MatchSquad' },
    ...
    },
    {
      ...
      routes: [
        ...
        { path: '/admin/business/wishes', component: '@/pages/admin/business/Wishes' },
        ...
        { path: '/admin/business/gifts', component: '@/pages/admin/business/Gifts' },
        ...
        { path: '/admin/business/drift-bottles', component: '@/pages/admin/business/DriftBottles' },
        { path: '/admin/business/wish-assets', component: '@/pages/admin/business/WishAssetAdmin' },
