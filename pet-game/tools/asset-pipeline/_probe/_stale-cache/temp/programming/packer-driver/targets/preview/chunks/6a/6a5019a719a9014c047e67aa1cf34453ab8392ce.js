System.register([], function (_export, _context) {
  ...
  function report(imported, moduleRequest, importMeta, extras) {
    console.warn("Found possible circular reference in \"".concat(importMeta.url, "\", happened when use \"").concat(imported, "\" imported from \"").concat(moduleRequest, "\" "), extras.error);
  }
