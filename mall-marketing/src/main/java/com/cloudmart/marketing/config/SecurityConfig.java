    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/group/activities").permitAll()
                .requestMatchers(HttpMethod.GET, "/group/activities/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/group/orders").permitAll()
                .requestMatchers(HttpMethod.GET, "/group/orders/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/tiered/promotions/*").permitAll()
